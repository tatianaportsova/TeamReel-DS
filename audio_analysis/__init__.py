...
speech-to-text transcription of the audio (get_transcripts_from_audio),
and for audio sentiment analysis.
"""

from .audio_functions import get_audio_from_video, get_transcripts_from_audio
from .audio_functions import get_sentiment_analysis


__all__ = ["get_audio_from_video",
           "get_transcripts_from_audio",
